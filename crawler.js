...
/***/ function(module, exports, __webpack_require__) {
	...
	var crawl = function () {
	  var ref = (0, _asyncToGenerator3.default)(_regenerator2.default.mark(function _callee() {
	    var presidentCounter, speechCounter, paragraphCounter, currentSpeaker, currentRecord, indexPageHtml, indexDom, listing, index, element, _class, presidentName, link, href, text, matches, dateMatch, dateString, date, title, speechSlug, speechUrl, baseRecord, speechHtml, speechDom, recordParagraphs, wordsInSpeechCount, paragraphsInSpeechCount, mainElement, transcriptHtml, paras, pIndex, para, indexRecords, rIndex, rPara, paragraphSlug, indexRecord;
	      ...
	      while (1) {
	        switch (_context.prev = _context.next) {
	          case 0:
	            ...
	            paragraphCounter = 0;
	            _context.next = 6;
	            return getHtml('index', 'http://millercenter.org/president/speeches');

	          case 6:
	            indexPageHtml = _context.sent;
	            indexDom = getDom(indexPageHtml);
	            listing = (0, _soupselect.select)(indexDom, "#listing")[0];
	            _context.t0 = _regenerator2.default.keys(listing.children);
	          ...
	          case 10:
	            ...
	            element = listing.children[index];
	            _class = element.attribs ? element.attribs.class : '';

	            if (_class === "president") {
	              presidentName = element.children[0].data.trim();
	            ...
	            link = (0, _soupselect.select)(element, 'a')[0];
	            href = link.attribs.href;
	            text = _domutils2.default.getText(link);
	            matches = text.match(/\([^)]+\)/g);
	            dateMatch = matches[matches.length - 1];
	            dateString = dateMatch.replace(/[\(\)]/g, '');
	            date = new Date(Date.parse(dateString));
	            title = text.replace(dateMatch, '').trim();
	            speechSlug = (0, _slug2.default)(text);
	          ...
	          case 27:
	            speechUrl = 'http://millercenter.org' + href;
	            ...
	            _context.next = 31;
	            return getHtml(text.replace(/\//, '-'), speechUrl);

	          case 31:
	            speechHtml = _context.sent;
	            speechDom = getDom(speechHtml);
	            recordParagraphs = [];
	            wordsInSpeechCount = 0;
	            paragraphsInSpeechCount = 0;
	            mainElement = (0, _soupselect.select)(speechDom, "#transcript")[0];
	            transcriptHtml = _domutils2.default.getInnerHTML(mainElement);
	            ...
	            paras = transcriptHtml.split(/\n/);
	            _context.t2 = _regenerator2.default.keys(paras);
	          ...
	          case 45:
	            ...
	            pIndex = _context.t3.value;
	            para = paras[pIndex].trim();
	          ...
	          case 58:
	            ...
	            for (rIndex in recordParagraphs) {
	              rPara = recordParagraphs[rIndex];
	              paragraphSlug = speechSlug + '-' + rIndex;
	              indexRecord = (0, _assign2.default)({
	            ...
	            _context.next = 62;
	            return paragraphsIndex.saveObjects(indexRecords);
	          ...
	          case 66:
	            ...
	            console.log("Finished! Presidents=%s, speeches=%s, paragraphs=%s", presidentCounter, speechCounter, paragraphCounter);
	            process.exit(0);
	          ...
	          case 70:
	            ...
	            console.log((0, _stringify2.default)(currentRecord, undefined, ' '));
	            console.error("ERROR", _context.t4);
	            process.exit(-1);
	...
	var getHtml = function () {
	  var ref = (0, _asyncToGenerator3.default)(_regenerator2.default.mark(function _callee2(key, url) {
	    var filename, html;
	      ...
	      while (1) {
	        switch (_context2.prev = _context2.next) {
	          case 0:
	            ...
	            return _context2.abrupt('return', _fs2.default.readFileSync(filename, 'utf8'));
	          ...
	          case 7:
	            ...
	            _fs2.default.writeFileSync(filename, html, 'utf8');
	...
	var _slug = __webpack_require__(100);
